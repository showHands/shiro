...
public class ShiroConfiguration {
    ...
    /**
     * serRealm.credentialsMatcher=$credentialsMatcher
    ...
    public UserRealm myShiroRealm(){
        ...
        userRealm.setAuthorizationCacheName("weimaiAuthorizationCacheName");
        userRealm.setAuthorizationCachingEnabled(true);
        userRealm.setAuthenticationCachingEnabled(true);
        userRealm.setAuthenticationCacheName("weimaiAuthenticationCacheName");
